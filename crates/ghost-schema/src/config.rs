//! Configuration types for Ghost API
//!
//! This module contains all configuration-related types used
//! across the Ghost API system.

use serde::{Deserialize, Serialize};
use std::collections::HashMap;

use crate::{GhostError, Platform, Strategy};
...
impl GhostConfig {
    ...
    pub fn from_toml(_toml: &str) -> Result<Self, GhostError> {
